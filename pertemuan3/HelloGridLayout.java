...
public class HelloGridLayout extends JFrame implements ActionListener{
	...
	JButton buttonD = new JButton("Jakarta");
	JButton buttonE = new JButton("Bandung");
	JButton buttonF = new JButton("Surabaya");
	JButton buttonG = new JButton("Jakarta");
	JButton buttonH = new JButton("Bandung");
	JButton buttonI = new JButton("Surabaya");
